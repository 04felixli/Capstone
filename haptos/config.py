...
STEREO_DEFAULT_CAMERA_FPS = 30.0
STEREO_DEFAULT_MAX_SKEW_MS = 8.0
STEREO_DEFAULT_MAX_DEPTH_M = 8.0
STEREO_DEFAULT_MIN_VALID_FRACTION = 0.15
STEREO_DEFAULT_MAX_RELATIVE_UNCERTAINTY = 0.35
STEREO_DEFAULT_SMOOTHING_WINDOW = 5
HAZARD_DEFAULT_MAX_DISTANCE_M = 2.5
